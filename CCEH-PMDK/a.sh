...
g++ -std=c++17 -w -I./ -L /usr/local/lib/ -L /usr/lib -L ./lib2/pcm/ -I /usr/include/ -I /usr/local/include/ -I ./src2/ -I ./lib2/pcm/ -lrt -lpthread -mavx512f -msse -msse2 -msse3 -O3 -o cceh_test CCEHonPmem.cpp src/CCEH_LSB.cpp src2/util/slice.cc src2/util/histogram.cc src2/util/status.cc -lpmem -lpmemobj -pthread
